...
TRUNCATE TABLE interest_community_chat_clear;
...
('welcome_taiji', 'taiji', 'system', NULL, '群助手', 'elder', 'text', '欢迎来到太极晨练群！可按住说话、点键盘输入文字，或点 + 发送图片。', NULL, NULL, 0, '2026-04-01 08:05:00.000'),
('welcome_calligraphy', 'calligraphy', 'system', NULL, '群助手', 'elder', 'text', '欢迎来到书法兴趣班！可按住说话、点键盘输入文字，或点 + 发送图片。', NULL, NULL, 0, '2026-04-02 09:35:00.000'),
('welcome_fitness', 'fitness', 'system', NULL, '群助手', 'elder', 'text', '欢迎来到健身活力群！可按住说话、点键盘输入文字，或点 + 发送图片。', NULL, NULL, 0, '2026-04-06 16:15:00.000'),
