...
class AiConsultationHistoryPage extends StatefulWidget {
  const AiConsultationHistoryPage({
    super.key,
  ...
  @override
  State<AiConsultationHistoryPage> createState() =>
      _AiConsultationHistoryPageState();
}

class _AiConsultationHistoryPageState extends State<AiConsultationHistoryPage> {
  late Future<List<AiConsultationHistoryItem>> _future = _load();

  Future<List<AiConsultationHistoryItem>> _load() {
    return AiMedicalAssistantApi.getConsultationHistory(
        ...
        return DraggableScrollableSheet(
          ...
          builder: (context, scrollController) {
            return FutureBuilder<AiConsultationDetail>(
              future: AiMedicalAssistantApi.getConsultationDetail(id),
