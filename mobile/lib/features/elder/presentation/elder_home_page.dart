      ...
      children: [
        Row(
          ...
          children: [
            ...
            _SosCircleButton(onTap: onSosTap),
          ],
        ),
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton(
                        onPressed: () => Navigator.of(context).pop(_HelpSheetResult.revokeByButton),
                    ...
                    Expanded(
                      child: FilledButton(
                        onPressed: () => Navigator.of(context).pop(_HelpSheetResult.sendNow),
